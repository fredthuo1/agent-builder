...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 980, margin: "0 auto", padding: 24 }}>
      <h1 style={{ fontSize: 28, fontWeight: 800, margin: 0 }}>Daily Workout Tracker</h1>
      <p style={{ opacity: 0.7 }}>A simple application to track and manage daily workout habits and progress.</p>
      ...
      <section style={{ marginTop: 14, padding: 14, border: "1px solid #eee", borderRadius: 14 }}>
        <div style={{ fontWeight: 700, marginBottom: 10 }}>Create workout</div>
