    ...
    <div className="container">
      <div className="nav">
        <div className="brand">
          ...
          <div>Build a mini CRM for contacts with fields name</div>
        </div>
      ...
      <div className="panel">
        ...
        <div className="panelBody">
          <div style={{display:"grid", gap: 12, gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))"}}>
            <a className="card" href="/entity/mini">
  <div style={{fontWeight: 900}}>Minis</div>
  <div className="small">Manage minis (CRUD)</div>
</a>
          </div>
