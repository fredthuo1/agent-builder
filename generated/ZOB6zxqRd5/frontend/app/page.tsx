    ...
    <main style={{ maxWidth: 1100, margin: "0 auto", padding: 24 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start" }}>
        <div>
          ...
          <p style={{ opacity: 0.7, marginTop: 6 }}>Full-stack app generated from: "Build a mini CRM for contacts with fields: name, email, phone, company, stage (lead, qualified, customer), notes."</p>
        </div>
